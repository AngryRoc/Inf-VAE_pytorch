...
flags.DEFINE_boolean('use_feats', True, 'Use features in GCN or not')
...
flags.DEFINE_integer('hidden1_dim', 256, 'VAE NN layer config: comma separated number of units')
flags.DEFINE_integer('hidden2_dim', 128, 'VAE NN layer config: comma separated number of units')
flags.DEFINE_integer('hidden3_dim', 64, 'VAE NN layer config: comma separated number of units')
...
flags.DEFINE_float('vae_pos_weight', 100, 'Pos weight for vae.')
